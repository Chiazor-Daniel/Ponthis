...
const PricingBlog = ({ title }) => {
        ...
        switch (title) {
            ...
            case "Gold":
                return [
                    ...
                    "Priority Support",
                    "Full Access to Enterprise Resources",
            ...
            case "Platinum":
                return [
                    "All Features in Ultimate Package",
    ...
    // Pass the features to the PriceList component
    return <PriceList features={features} />;
};

const pricingBlog = [
    { price: '250', title: 'Basic', title2: 'Life-includes:' },
    { price: '2K', title: 'Premium', content: <div className="tagline">POPULER</div>, title2: 'Everythings in Lite, Plus' },
    { price: '10k', title: 'Gold', title2: 'Everything in Premium, Plus' },
    { price: '50k', title: 'Platinum', title2: 'Everything in Ultimate, Plus' },
];
    ...
    return(
        <> 
            {pricingBlog.map((data, index)=>(
                <div className="col-xl-4 col-lg-6 col-md-6 m-b30" key={index} style={{cursor: "pointer"}}>
                        ...
                        <div className="pricingtable-inner">
                            ...
                            <h4 className="pricingtable-title">
                                ...
                                <svg width="20" height="28" viewBox="0 0 20 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.01937 28C6.91043 28 6.80018 27.9782 6.69485 27.9328C6.3262 27.7738 6.12681 27.3714 6.22361 26.9818L8.99757 15.8158H1.52346C1.25292 15.8158 0.999772 15.6825 0.846811 15.4593C0.693851 15.2361 0.660765 14.9519 0.758382 14.6996L6.24144 0.524396C6.36366 0.208359 6.66762 0 7.00646 0H14.5512C14.8284 0 15.0868 0.139999 15.2383 0.372202C15.3897 0.604404 15.4136 0.897364 15.3019 1.15106L12.0551 8.52072H18.4765C18.7765 8.52072 19.0526 8.6845 19.1964 8.94782C19.3402 9.21109 19.3289 9.53188 19.1667 9.78432L7.70996 27.6229C7.55503 27.8642 7.29154 28 7.01937 28ZM2.72029 14.1753H10.0466C10.299 14.1753 10.5373 14.2915 10.6928 14.4903C10.8482 14.6891 10.9035 14.9484 10.8427 15.1934L9.01315 22.5578L16.9747 10.1613H10.7973C10.5201 10.1613 10.2617 10.0213 10.1102 9.78908C9.95881 9.55688 9.93485 9.26392 10.0466 9.01028L13.2934 1.64062H7.5687L2.72029 14.1753Z" fill="#A1C398 "/>
                                </svg>
                                :
                                <GiCutDiamond color='#A1C398' size={30}/>
                                }
                                {" "} {data.title}
                            </h4>
                            <p style={{color: "white"}}>Perfect to get started</p>
                            <div className="pricingtable-price">
                                <h2 className="pricingtable-bx"><span style={{color: "#A1C398"}}>$</span>{data.price}<small>balance</small></h2>
                                {
                                    index === 0 && (
                                        <div className="days-label" style={{backgroundColor: "#A1C398"}}>Try 7 Days for free</div>
                                    )
                                }
                                <h6>{data.title2}</h6>
                            </div>
                            <PricingBlog title={data.title} />
                        </div>
