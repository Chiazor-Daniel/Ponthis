...
import LoanApplicationPage from './AllUsers/User/loanMgt';
import ReviewList from './AllUsers/Admin/Reviews';
...
const pages = [
  ...
  {path: '/dashboard/loan-app', component: LoanApplicationPage},
...
const adminPages = [
  ...
  { path: "/admin/admin-website/reviews", component: ReviewList },
