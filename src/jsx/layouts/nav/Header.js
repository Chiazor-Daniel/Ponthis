...
const Header = ({ onNote }) => {
	...
	return (
		<div className={`header ${headerFix ? "is-fixed" : ""}`}>
			<div className="header-content" style={{ alignItems: "center", justifyContent: "center" }}>
															...
															<li key={item.id}>
																...
																<Link className="timeline-panel c-pointer text-muted" to="#">
																	...
																	<h6 className="mb-0">
																		{item.title}{" "}
																		{item.subTitle && (
																			<strong className="text-info">{item.subTitle}</strong>
																		)}
																	</h6>
								...
								<ul>
									<Dropdown as="li" className="nav-item dropdown header-profile">
										<Dropdown.Toggle variant="" as="a" className="nav-link i-false c-pointer">
											<img src={"https://i.guim.co.uk/img/media/70a2fd5f5acddd683b892245209974fa4c768498/324_0_1429_858/master/1429.jpg?width=1200&height=1200&quality=85&auto=format&fit=crop&s=e2b8991e17e7bd966a29f5c706fe2552"} width={20} alt="" />
										</Dropdown.Toggle>
