                                ...
                                <div className="card-header border-0">
                                    <Nav as="ul" className="order  nav-tabs" id="pills-tab" role="tablist">
                                        <Nav.Item as="li" className="my-1" role="presentation">
                                            <Nav.Link as="button" eventKey="All" type="button" style={{color: '#fff',}} onClick={() => setCurrentTab("All")}>All</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item as="li" className="my-1" role="presentation">
                                            <Nav.Link as="button" eventKey="Spot" type="button"  style={{color: '#fff',}}  onClick={() => setCurrentTab("bank")}>Bank Transfer</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item as="li" className="my-1" role="presentation">
                                            <Nav.Link as="button" className="me-0" eventKey="Listing" type="button"  style={{color: '#fff',}}  onClick={() => setCurrentTab("card")}>Card Payment</Nav.Link>
                                        </Nav.Item>
