                                        ...
                                        <div className="widget widget_getintuch">
                                            <ul>
                                                <li>
                                                    ...
                                                    <a href={`tel:${'+447949453284'}`}>+447949453284<br/>***</a> 
                                                </li>
                                                <li>
                                                    <i className="fa fa-envelope"></i> 
                                                    <span>info@atlaswavestrader.com</span>
                                                </li>
                                                <li>
                                                    <i className="fa fa-envelope"></i> 
                                                    <span>support@atlaswavestrader.com</span>
                                                </li>
                                                <li>
                                                    <i className="fas fa-map-marker-alt"></i>
                                                    <span>123 Oxford Street, London, W1D 1BT, United Kingdom</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
