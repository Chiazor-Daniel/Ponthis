...
import UserLoanRequests from './userLoan';
    ...
    const handleLoginUser = async () => {
        try {
            ...
            if (loginRes.data.status === 'success') {
                ...
                sessionStorage.setItem("logAdmin", true); 
        ...
        <>
            ...
            <div className=''>
                ...
                <div className='row' style={{ gap: "50px", display: "flex", justifyContent: "center", }}>
                    <div className='card col-12 col-lg-5' style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "20px", fontSize: "1.3rem", backgroundColor: '#2a2a2a', }}>
                    ...
                    <div className='row mb-4' style={{ padding: "20px", marginTop: "20px" }}>
                        ...
                        {userBalances && (
                            <div className="col-md-6 mb-4" >
                                <div className="card shadow-sm h-100" style={{backgroundColor: '#2a2a2a',}}>
                ...
                <UserLoanRequests token={adminToken} userId={id}/>
