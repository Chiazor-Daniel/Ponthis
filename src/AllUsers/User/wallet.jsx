...
const WalletCard = ({ handleTransfer, userToken, refetchUserAssets, currency, refetchAllAssets, handleAction }) => {
  ...
  return (
    <div className="col-xl-4 col-12" style={{ height: 'auto',  backgroundColor: '#2a2a2a', borderRadius: '10px', paddingTop: '20px', paddingBottom: '20px' }}>
      <div className=''>
        <ImageSwiper cards={cards || []} toggleCardStatus={toggleCardStatus} userToken={userToken}/>
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <CryptoPurchaseComponent userToken={userToken} refetchUserAssets={refetchUserAssets} currency={currency} refetchAllAssets={refetchAllAssets} handleAction={handleAction}/>
        </div>
      </div>
    </div>
  );
